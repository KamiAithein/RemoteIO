        ...
        std::thread::spawn(move || {
            loop {
                ...
                match bincode::deserialize(&buf).expect("could not deserialize!") {
                    crate::BinMessages::BinConfig(crate::AliasedData{alias, data: config}) => {
                    ...
                    crate::BinMessages::BinData(crate::AliasedData{alias, data}) => {
                        let mut ul_batches = batches.lock().expect("could not lock batches!");
                    ...
                    crate::BinMessages::BinHello(crate::BinStreamAlias{alias}) => {
